...
# 경로 설정
benign_ast_dirs = ['D:/PowerShell/Extraction/CSV/GithubGist']
...
malicious_ast_dir = 'D:/PowerShell/Extraction/CSV/Encoded_Powershell/Mentor_Obj_Feature(Unobfuscated)'
...
X_texts = [text for text in benign_texts + obfuscated_benign_texts + malicious_texts + obfuscated_malicious_texts if
           text.strip()]
y_labels = benign_labels + obfuscated_benign_labels + malicious_labels + obfuscated_malicious_labels[:len(X_texts)]

...
# 그래프 시각화 (정상 난독화 및 악성 난독화 샘플 각각 시각화)
# 정상 난독화 샘플 시각화
...
plt.title("Graph Visualization of Normal Obfuscated Sample (Directed)")
plt.show()
...
plt.figure(figsize=(8, 6))
nx.draw(G_malicious, with_labels=True, node_color='lightcoral', node_size=500, edge_color='gray', arrows=True)
plt.title("Graph Visualization of Malicious Obfuscated Sample (Directed)")
plt.show()

...
def train_cnn_model():
    ...
    # 이미지 경로 설정 및 라벨링
    normal_dir_1 = "D:/PowerShell/Extraction/byte histogram_24.10.30/normal/Github/global_entropy/Github"  # 정상
    obfuscated_normal_dir_1 = "D:/PowerShell/Extraction/byte histogram_24.10.30/normal/global_entropy/invokeCradleCrafter"  # 정상 난독화
    obfuscated_normal_dir_2 = "D:/PowerShell/Extraction/byte histogram_24.10.30/normal/global_entropy/InvokeObfuscation"  # 정상 난독화
    obfuscated_normal_dir_3 = "D:/PowerShell/Extraction/byte histogram_24.10.30/normal/global_entropy/IseSteroids"  # 정상 난독화
    attack_dir_1 = "D:/PowerShell/Extraction/byte histogram_24.10.30/attack/global_entropy/attack_decoded"  # 악성
    attack_dir_2 = "D:/PowerShell/Extraction/byte histogram_24.10.30/attack/global_entropy/attack_original"  # 악성 난독화

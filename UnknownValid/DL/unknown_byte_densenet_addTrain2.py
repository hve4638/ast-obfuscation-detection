...
def train_cnn_densenet_model():
    ...
    # 데이터 결합
    X = np.concatenate((obfuscated_normal_images, attack_images, validation_images), axis=0)
    y = np.concatenate((obfuscated_normal_labels, attack_labels, validation_labels), axis=0)
